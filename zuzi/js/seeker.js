...
Seeker.getVersion = function() {return "nf";};
Seeker.blockFlagMap = {'#': 0x0001, 'A': 0x0002, 'B': 0x0004, 'C': 0x0008, 'D': 0x0010, 'E': 0x0020, 'F': 0x0040, 'G': 0x0080, 'H': 0x0090, 'I': 0x0100, 'J': 0x0110, 'X': 0x2000, 'Y': 0x4000, 'Z': 0x8000};
Seeker.blockMap = {1: 0x0001, 2: 0x0002, 3: 0x0004, 4: 0x0008, 5: 0x0010, 6: 0x0020, 7: 0x0040, 8: 0x0080, 9: 0x0090, 10: 0x0100, 11: 0x0110, 28: 0x2000, 29: 0x2000, 30: 0x4000};

//Seeker.blockFlagMap = {'#': 0x0001, 'A': 0x0002, 'B': 0x0004, 'C': 0x0008, 'D': 0x0010, 'E': 0x0020, 'F': 0x0040, 'G': 0x0080, 'H': 0x0090, 'I': 0x0100, 'J': 0x0110, 'X': 0x2000, 'Y': 0x4000, 'Z': 0x8000};
//Seeker.blockMap = {1: 0x0001, 2: 0x0002, 3: 0x0004, 4: 0x0008, 5: 0x0010, 6: 0x0020, 7: 0x0040, 8: 0x0080, 9: 0x0090, 10: 0x0100, 11:0x0110, 28: 0x2000, 29: 0x2000, 30: 0x4000};

//Seeker.blockMap = {1: 0x0001, 2: 0x0002, 3: 0x0004, 4: 0x0008, 5: 0x0010, 6: 0x0020, 7: 0x0040, 8: 0x0080, 9: 0x0090, 10: 0x0100, 27: 0x2000, 28: 0x2000, 29: 0x2000, 30: 0x4000, 31: 0x4000};
//Seeker.dataIndexMap = {1: -0x4DCF, 2: 0x1E2E, 3: -0x19412, 4: -0x19434, 5: -0x1943F, 6: -0x19441, 7: -0x1944F, 8: -0x1A86E, 9:-0x1A86E, 27: 0x71DD, 28: 0x71DB, 29: -0x18B4B, 30: -0xD939D, 31: -0xDD1D4};
...
Seeker.parts = {
	...
	'󰒬':3,'󰊎':3,'󰐸':3,'󰐧':3,'󰐷':3,'刃':4,'𭤨':3,'𰀄':3,'吅':3,'从':3,'󰒊':3,'中':4,'󰑲':3,'󰩮':3,'𰀁':3,'𠂔':3,'𪩲':3,'亞':4,'𡕰':3,'䜌':2,'龻':2,'畺':2,'畕':4,'东':4,'亍':2,'𬴘':2,'𱷥':3,'龟':4,'龙':4,'𱥯':4,'𫜹':1,'𪛙':3,'林':4,'α':3,'䀠':4,'𰀪':3,'巜':3,'𬻍':3,
	'𬺹':3,'𩫏':3,'𩫃':3,'𩫗':3,'𬻌':3,'\u27bf':3,'コ':2,'𫩏':3
};
...
UI.strokeKeyboard = {
	...
	className: 'strokeKB',
	groups: {
		'10画': '馬骨高髟鬥鬯鬲鬼𤇾丵𠂹𣆪𩠐𡸁隺尃𧴪𥁕臽䍃芻皋畕䀠',
		'11画': '魚鳥鹵鹿麥麻㒼𦰩𠦬𠁁𱷥桼啇袞翏啚悤粛',
		'12画': '黃黍黑黹𤔔𠥓菐巽粦尌朁尞厤肅',
		'13画': '黽鼎鼓鼠畺𦥯𦝠𢊁廌𠌶𡕰亶嗇睘',
		'14画': '鼻齊𨛜𩫃㥯熏',
		'15画': '齒𬴘嘼廛巤',
...
Seeker.getCJKBlock = function(c) {
	...
	if (c >= 0x2A700 && c <= 0x2B73A) return 4;
	if (c >= 0x2B740 && c <= 0x2B81F) return 5;
	if (c >= 0x2B820 && c <= 0x2CEAF) return 6;
...
Seeker.getTree = function(str, divide) {
	...
	if (str.length) {
		...
		if (p == '') {
			...
			var strs = p.split('‖');
			for (var i in strs) {
				html += UI.addCell({'char': w, 'unicode': c, 'text': strs[i].length ? strs[i] : "(无法再分解)"});
			}
		}
	}
	return html;
...
UI.blockClasses = {1: 'BSC', 2: 'ExA', 3: 'ExB', 4: 'ExC', 5: 'ExD', 6: 'ExE', 7: 'ExF', 8: 'ExG', 9: 'ExH', 10: 'ExI', 11: 'ExJ', 27: 'CMP', 28: 'CMP', 29: 'CMP', 30: 'SUP', 31: 'SUP'};

//UI.blockClasses = {1: 'BSC', 2: 'ExA', 3: 'ExB', 4: 'ExC', 5: 'ExD', 6: 'ExE', 7: 'ExF', 8: 'ExG', 9: 'ExH', 10: 'ExI', 10: 'ExJ', 27: 'CMP', 28: 'CMP', 29: 'CMP', 30: 'SUP', 31: 'SUP'};
...
UI.showPop = function(e) {
	...
	var change = function() {
		...
		if (Config.useImage[k]) $('#bigchar').addClass('img').css({'background-image': 'url(' + Config.glyphwiki + u.toString(16) + '.svg)'});
		UI.popTrigger = c;
...
UI.createTag = function(c, tag, cls, extra, hideChar, running) {
	...
	var tagBody = Config.useImage[Seeker.getCJKBlock(code)] && !running ?
		' img" data-char="' + c + '" style="background-image: url(' + Config.glyphwiki + code.toString(16) + '.svg)">' + (hideChar ? '&nbsp;' : c) :
		'" data-char="' + c + '">' + c;
	return '<' + tag + ' ' + (extra || '') + ' onclick=' + ' UI.setClipboard("' + c + '") ' + ' class="' + (cls || '') + tagBody + '</' + tag + '>';
};
...
UI.setResult = function(founds, i, force) {
	...
	var msg = force ? '' : '<span style="color:green">(基本区)</span> ';
	msg += Seeker.groups ? '共找到 ' + founds.length + ' 字' : '找到 ' + founds.length + ' 字 ' + Math.floor(i*100 / dt.length) + '%';
	$('#counter').html(msg);
	UI.showOutput();
};
